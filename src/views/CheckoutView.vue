<template>
  <div class="checkout-page">
    <b-container>
      <h1 class="page-title text-center mt-4 mb-5">My Checkout</h1>

      <div v-if="cart.length > 0">
        <b-row>
          <b-col lg="8">
            <b-card class="mb-4 rounded-lg checkout-card">
              <h4 class="mb-3 section-heading">Contact Information</h4>
              <b-form @submit.prevent="submitOrder">
                <b-row>
                  <b-col md="6">
                    <b-form-group label="First Name" label-for="firstName">
                      <b-form-input id="firstName" v-model="form.firstName" required placeholder="First Name" class="rounded-pill" />
                    </b-form-group>
                  </b-col>
                  <b-col md="6">
                    <b-form-group label="Last Name" label-for="lastName">
                      <b-form-input id="lastName" v-model="form.lastName" required placeholder="Last Name" class="rounded-pill" />
                    </b-form-group>
                  </b-col>
                </b-row>

                <b-form-group label="Email" label-for="email">
                  <b-form-input id="email" type="email" v-model="form.email" required placeholder="Email" class="rounded-pill" />
                </b-form-group>

                <b-form-group label="Phone" label-for="phone">
                  <b-form-input id="phone" v-model="form.phone" required placeholder="Phone Number" class="rounded-pill" />
                </b-form-group>

                <h4 class="mt-4 mb-3 section-heading">Shipping Address</h4>
                <b-form-group label="Address" label-for="address">
                  <b-form-input id="address" v-model="form.address" required placeholder="Address" class="rounded-pill" />
                </b-form-group>

                <b-row>
                  <b-col md="4">
                    <b-form-group label="City" label-for="city">
                      <b-form-input id="city" v-model="form.city" required placeholder="City" class="rounded-pill" />
                    </b-form-group>
                  </b-col>
                  <b-col md="4">
                    <b-form-group label="State / Province" label-for="state">
                      <b-form-input id="state" v-model="form.state" required placeholder="State / Province" class="rounded-pill" />
                    </b-form-group>
                  </b-col>
                  <b-col md="4">
                    <b-form-group label="Postal Code" label-for="postalCode">
                      <b-form-input id="postalCode" v-model="form.postalCode" required placeholder="Postal Code" class="rounded-pill" />
                    </b-form-group>
                  </b-col>
                </b-row>

                <h4 class="mt-4 mb-3 section-heading">Payment Method</h4>
                <b-form-group>
                ...
                <div v-if="form.paymentMethod === 'frame'" class="payment-details">
                  <b-alert show variant="info" class="rounded-lg">
                ...
                <b-button type="submit" variant="primary" size="lg" class="mt-4 rounded-pill px-5">
                  <b-icon icon="check-circle" class="mr-2" /> Place Order
                </b-button>
              </b-form>
            </b-card>
          </b-col>
          ...
          <b-col lg="4">
            <b-card class="order-summary curved-box">
              <h4 class="mb-3 section-heading">Order Summary</h4>
              <b-list-group flush>
              ...
              <div class="mt-3">
                <b-form-group label="Promo code" label-for="promoCode">
                  <b-input-group>
                    <b-form-input id="promoCode" v-model="form.promoCode" placeholder="Promo code" class="rounded-pill" />
                    <b-input-group-append>
                      <b-button variant="warning" class="rounded-pill">Apply</b-button>
                    </b-input-group-append>
                  </b-input-group>
                </b-form-group>
              </div>
      ...
      <div v-else class="text-center py-5">
        <b-icon icon="cart-x" font-scale="5" variant="warning" class="mb-4" />
        ...
        <b-button variant="primary" to="/" class="mt-3 rounded-pill px-4">
          <b-icon icon="bag" class="mr-2" /> Shop Now
        </b-button>
      </div>
    </b-container>
  </div>
